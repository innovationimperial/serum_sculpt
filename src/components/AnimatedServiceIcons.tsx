...
export const SupportIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className={className}>
        <defs>
          ...
          .anim-petals {
            animation: breathePetals 4s ease-in-out infinite;
            transform-origin: center;
          }
          .anim-orbit {
            animation: orbitSupport 5s linear infinite;
            transform-origin: center;
          }
          .anim-leaf-l {
            animation: leafMove 3s ease-in-out infinite;
            transform-origin: bottom right;
          }
          .anim-leaf-r {
        ...
        {/* Stem and Base Leaves */}
        <g transform="translate(100, 100)">
            <path d="M0,0 Q5,30 0,60" fill="none" stroke="#22c55e" strokeWidth="6" strokeLinecap="round" />

            <g className="anim-leaf-l" transform="translate(0, 40)">
                <path d="M0,0 Q-20,10 -25,-10 Q-5,-10 0,0 Z" fill="#4ade80" />
            </g>
            <g className="anim-leaf-r" transform="translate(0, 30)">
                <path d="M0,0 Q20,10 25,-10 Q5,-10 0,0 Z" fill="#4ade80" />
            </g>
        </g>

        {/* Petals and Center */}
        <g transform="translate(100, 100)" className="anim-petals">
            {/* 8 Petals */}
            <ellipse cx="0" cy="-30" rx="15" ry="30" fill="url(#petalGrad)" />
            <ellipse cx="21" cy="-21" rx="15" ry="30" transform="rotate(45)" fill="url(#petalGrad)" />
            <ellipse cx="30" cy="0" rx="15" ry="30" transform="rotate(90)" fill="url(#petalGrad)" />
            <ellipse cx="21" cy="21" rx="15" ry="30" transform="rotate(135)" fill="url(#petalGrad)" />
            <ellipse cx="0" cy="30" rx="15" ry="30" transform="rotate(180)" fill="url(#petalGrad)" />
            <ellipse cx="-21" cy="21" rx="15" ry="30" transform="rotate(225)" fill="url(#petalGrad)" />
            <ellipse cx="-30" cy="0" rx="15" ry="30" transform="rotate(270)" fill="url(#petalGrad)" />
            <ellipse cx="-21" cy="-21" rx="15" ry="30" transform="rotate(315)" fill="url(#petalGrad)" />

            {/* Center Face */}
            <circle cx="0" cy="0" r="20" fill="url(#centerGrad)" />
            <circle cx="-7" cy="-5" r="2.5" fill="#ca8a04" />
            <circle cx="7" cy="-5" r="2.5" fill="#ca8a04" />
            <path d="M-8,5 Q0,12 8,5" fill="none" stroke="#ca8a04" strokeWidth="2.5" strokeLinecap="round" />
        </g>

        {/* Orbiting Support Dot */}
        <g transform="translate(100, 100)">
            <g className="anim-orbit">
                <circle cx="0" cy="0" r="8" fill="#10b981" />
                <path d="M-3,-1 L3,-1 M0,-4 L0,2" stroke="#fff" strokeWidth="2" strokeLinecap="round" transform="rotate(45)" />
                {/* Simple trail approximation */}
                <circle cx="-15" cy="15" r="5" className="trail" opacity="0.6" />
                <circle cx="-25" cy="25" r="3" className="trail" opacity="0.3" />
                <circle cx="-32" cy="32" r="1.5" className="trail" opacity="0.1" />
            </g>
        </g>
    </svg>
);
