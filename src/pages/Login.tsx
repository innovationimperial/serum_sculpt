        ...
        <div ref={containerRef} className="bg-[#f8f7f5] min-h-screen flex flex-col pt-32 pb-24 px-4">
            <div className="max-w-md w-full mx-auto flex-1 flex flex-col justify-center">
                <div className="text-center mb-12 auth-reveal">
                    ...
                    <h1 className="font-serif italic text-4xl text-charcoal mb-4">Patient Portal.</h1>
                    <p className="font-sans text-sm text-charcoal/60">Log in to manage your clinical profile and secure your appointments.</p>
                </div>
                ...
                <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-stone/20 border border-stone/50 auth-reveal">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end mt-2">
                            <a href="#" className="font-sans text-xs text-moss hover:text-charcoal transition-colors">Forgot password?</a>
                        </div>
                    ...
                    <p className="mt-8 text-center font-sans text-sm text-charcoal/60">
                        ...
                        <Link to={`/signup${searchParams.get('redirect') ? `?redirect=${encodeURIComponent(searchParams.get('redirect')!)}` : ''}`} className="text-moss font-bold hover:underline">
                            Initialize Profile
                        </Link>
                    </p>
                </div>
